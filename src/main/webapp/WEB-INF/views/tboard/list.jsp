			...
			<div class="col-md-12">
				...
				<div class='box'>
					<div class="box-header with-border">
						<h3 class="box-title"><b>영화 게시판</b></h3>
					</div>
					...
					<div class='box-body'>
						...
						<button id='newBtn'><b>글쓰기</b></button>
...
<%-- 									<td>${boardVO.rnum}</td> --%>
									<td><a
										href='/tboard/readPage?board_id=${cri.board_id}&${pageMaker.makeSearch(pageMaker.cri.page) }&bno=${boardVO.bno}'>
