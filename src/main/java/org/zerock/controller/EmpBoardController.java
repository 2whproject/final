...
public class EmpBoardController {
  ...
  public String modifyPagingPOST(EmpVO board, SearchCriteria cri, RedirectAttributes rttr) throws Exception {
  ...
  public String registPOST(EmpVO board, RedirectAttributes rttr) throws Exception {
